...
import GermanyGirl from '../assets/GermanyGirl.png';
import GermanySmallFlag from '../assets/GermanySmallFlag.png';
import GermanyQuestion from '../assets/GermanyQuestion.png';
		...
		<div>
				...
				<div className='md:flex items-center justify-between'>
					...
					<div className='md:w-3/6'>
						...
						<p className='md:text-2xl/loose text-lg/loose text-black text-center '>
							Key Reasons Nigerian Students Are Choosing Germany{' '}
						</p>
					</div>
				</div>
			</div>
			...
			<div className='relative w-full px-3 md:px-20 mt-10  md:mt-24 items-center'>
				...
				<p className='text-sm/loose mt-5 md:text-xl/loose font-light'>
					...
					This makes Germany one of the most affordable study-abroad destinations in the
					world.
				</p>
			</div>
			<div className='relative w-full px-3 md:px-20 mt-10  md:mt-24 items-center'>
				...
				<p className='text-sm/loose mt-5 md:text-xl/loose font-light'>
					...
					medicine, and business are especially strong.
				</p>
			</div>
