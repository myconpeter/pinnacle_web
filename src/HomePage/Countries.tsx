...
const Countries = () => {
	...
	return (
		<div
			...
			<div className='mt-10 flex gap-4 md:gap-10 overflow-x-auto scroll-smooth'>
				{allCountries.map(({ country, code, link }, i) => (
					<motion.div
						...
						<Link
							...
							<p className='text-center font-medium md:text-3xl md:mb-10'>{country}</p>
							<Flag code={code} className='h-12 w-12 md:h-20 md:w-20' />
						</Link>
					</motion.div>
				))}
				{/* Target for scroll */}
