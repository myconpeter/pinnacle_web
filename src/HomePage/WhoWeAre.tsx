...
const WhoWeAre = () => {
  return (
			...
			<div className='relative w-full px-3 md:px-6 mt-16 md:mt-24 items-center'>
				...
				<p className='mt-5 text-xl md:text-4xl/loose font-light space-y-20'>
					...
					Agency. With over 20 years of expertise, we have successfully trained, guided
					and placed students for admission into foreign universities.
				</p>
